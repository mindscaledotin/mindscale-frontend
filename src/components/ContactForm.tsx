...
//   return (
//     <div
//       className="text-white px-4 md:px-8 py-24 rounded-[10px] max-w-[1707px] mx-auto mt-20 shadow-xl font-lato"
//       style={{
//         background: "linear-gradient(90deg, #052275 0%, #040A19 100%)",
//       }}
//     >
//       <div
//         className="p-[2px] mx-2 md:mx-6 rounded-[12px]"
//         style={{
//           background: "linear-gradient(121.35deg, #35FEFE 0%, rgba(37, 84, 204, 0) 36.82%, rgba(55, 55, 178, 0) 57.86%, #35FEFE 99.46%)",
//         }}
//       >
...
//               <h2 className="text-[22px] md:text-[30px] font-bold leading-snug mb-3 md:mb-5 whitespace-nowrap">
...
//                   className="border-b border-gray-500 bg-transparent py-[12px] px-2 text-white placeholder:text-gray-400 text-xs md:text-sm focus:outline-none focus:border-blue-500"
//                 />
//                 <input
//                   type="text"
...
//                   <label className="block mb-2 text-white text-xs">
//                     Select Subject (Optional)
//                   </label>
//                   <div className="flex flex-wrap gap-6 items-center text-[12px] text-white">
//                     {[
//                       "General Inquiry",
//                       "Brand Identity",
//                       "UI/UX",
...
//                 <div className="col-span-2">
//                   <label className="block mb-2 text-white text-xs">Message</label>
//                   <textarea
//                     placeholder="Write your message..."
//                     rows={2}
//                     className="border-b border-gray-500 bg-transparent py-2 px-2 text-white placeholder-gray-400 resize-none focus:outline-none focus:border-blue-500 w-full text-xs md:text-sm"
//                   />
//                 </div>
